...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description: "Constantly learning and exploring new technologies to deliver cutting-edge solutions.",
    },
    {
      icon: Target,
      title: "User-Focused",
      description: "Every design decision is made with the end user in mind for optimal experience.",
    },
  ]
          ...
          <div className="w-full max-w-4xl">
            ...
            <div className="mb-12 md:mb-20">
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Welcome! I'm a passionate frontend developer based in Uzbekistan, dedicated to creating beautiful,
                performant, and accessible web experiences. With expertise in modern frontend technologies, I transform
            ...
            <div className="bg-card border border-border rounded-lg p-8 md:p-12 mb-12">
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl md:text-3xl font-semibold mb-2">Detailed Story</h2>
                <p className="text-muted-foreground">
                  A comprehensive look at my journey, experiences, and the projects that shaped me.
                </p>
              </div>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-8 md:p-10 mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {["Next.js", "React", "TypeScript", "Tailwind CSS", "JavaScript", "HTML5", "CSS3", "Git"].map(
                  (tech) => (
                    <div
                      key={tech}
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-8 md:p-10 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Interested in collaborating on a project? Feel free to reach out. I'm always open to discussing new
                ideas.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://t.me/abdulloh_io" target="_blank" rel="noopener noreferrer">
                  <Button className="rounded-full px-8" size="lg">
                    Get in Touch
                  </Button>
                </a>
                <a href="https://github.com/abdullokhmirzayev" target="_blank" rel="noopener noreferrer">
